...
(function($opal) {
  ...
  $opal.add_stubs(['$attr_reader', '$canvas_id', '$canvas', '$floor', '$/', '$height', '$width', '$>=', '$context', '$+', '$puts', '$p', '$page_x', '$page_y', '$[]', '$Document', '$e', '$scrollLeft', '$documentElement', '$scrollTop', '$body', '$-', '$new', '$*', '$on', '$get_cursor_position', '$x', '$y', '$fill_cell', '$find', '$unfill_cell', '$draw_canvas', '$add_mouse_event_listener']);
  ;
  ;
  ;
  (function($base, $super) {
    ...
    def.$get_cursor_position = function(event) {
      ...
      if ((($a = (($b = event.$page_x(), $b !== false && $b !== nil ?event.$page_y() : $b))) !== nil && (!$a._isBoolean || $a == true))) {
        ...
        x = self.$e()['$[]']("clientX")['$+'](doc.$scrollLeft())['$+'](doc.$documentElement().$scrollLeft());
        y = self.$e()['$[]']("clientY")['$+'](doc.$body().$scrollTop())['$+'](doc.$documentElement().$scrollTop());
      };
...
if (event == null) event = nil;
      coords = self.$get_cursor_position(event);
        ...
        return self.$fill_cell(x, y);}, TMP_1._s = self, TMP_1), $a).call($b, "click");
      return ($a = ($c = (($d = $scope.Element) == null ? $opal.cm('Element') : $d).$find("#" + (self.$canvas_id()))).$on, $a._p = (TMP_2 = function(event){var self = TMP_2._s || this, $a, coords = nil, x = nil, y = nil;
if (event == null) event = nil;
      coords = self.$get_cursor_position(event);
        $a = [coords.$x(), coords.$y()], x = $a[0], y = $a[1];
        return self.$unfill_cell(x, y);}, TMP_2._s = self, TMP_2), $a).call($c, "dblclick");
    };
